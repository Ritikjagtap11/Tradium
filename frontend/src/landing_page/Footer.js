        ...
        <div className="container border-top p-5 mt-5">
            <div className="row">
                <div className="col">
                    ...
                    <p>&copy; 2010 - 2026, Tradium Broking Ltd.
                        All rights reserved.</p>
                </div>
                <div className="col " style={{ lineHeight: "2.5rem"}} >
                    <p>Account</p>
                    <a href="#" className=" text-muted  ">Open demat account</a><br />
                    <a href="#" className=" text-muted  ">Minor demat account</a><br />
                    <a href="#" className=" text-muted  ">NRI demat account</a><br />
                    <a href="#" className=" text-muted  ">HUF demat account</a><br />
                    <a href="#" className=" text-muted  ">Commodity</a><br />
                    <a href="#" className=" text-muted  ">Dematerialisation</a><br />
                ...
                <div className="col" style={{ lineHeight: "2.5rem" }}>
                    ...
                    <a href="#" className=" text-muted  ">Tradium Connect blog</a><br />
                ...
                <div className="col" style={{ lineHeight: "2.5rem" }}>
                    ...
                    <a href="#" className=" text-muted  ">Tradium Cares (CSR)</a><br />
                    <a href="#" className=" text-muted  ">Tradium.tech</a><br />
                    <a href="#" className=" text-muted  ">Open source</a><br />
                    <a href="#" className=" text-muted  ">Referral program</a>
                </div>
                <div className="col" style={{ lineHeight: "2.5rem" }}>
                    <p>Quick links</p>
                    <a href="#" className=" text-muted  ">Upcoming IPOs</a><br />
                    <a href="#" className=" text-muted  ">Brokerage charges</a><br />
                    <a href="#" className=" text-muted  ">Market holidays</a><br />
                    <a href="#" className=" text-muted  ">Economic calendar</a><br />
                    <a href="#" className=" text-muted  ">Calculators</a><br />
                    <a href="#" className=" text-muted  ">Markets</a><br />
                    <a href="#" className=" text-muted  ">Sectors</a><br />
                    <a href="#" className=" text-muted  ">Gift Nifty</a>
                </div>
            </div>


            <div className="mt-5 text-muted text-justify small">
                <p>Tradium Broking Ltd.: Member of NSE, BSE, MCX & MSEI – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Tradium Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered Address: Tradium Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@tradium.com, for DP related to dp@tradium.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
